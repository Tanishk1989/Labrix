...
- The teacher practical-progress page renders the same deterministic top verified and needs-attention membership directly, limited to five students per group with neutral reason badges, latest-attempt context, score, hidden pass/total aggregate or unavailable state, review status, and review links. No AI request is needed to view the groups.
