...
14. The provider may explain the existing deterministic facts/signal and use them to draft viva questions, feedback, and manual inspection suggestions. It cannot calculate, replace, reclassify, or add facts, signal reasons, thresholds, categories, or scores.
