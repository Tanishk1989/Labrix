  ...
  return (
    <div className="w-full max-w-[460px] rounded-[32px] border border-white/10 bg-[#0d1017]/95 p-8 sm:p-10 shadow-[0_0_60px_rgba(0,0,0,0.8)] backdrop-blur-3xl transition-all">
      ...
      <div className="mt-6 space-y-3">
        ...
        <Link
          href="/sign-in"
          className="flex w-full items-center justify-center gap-3 rounded-2xl bg-white px-4 py-3.5 text-xs sm:text-sm font-semibold text-slate-900 shadow-md transition-all hover:bg-slate-100 active:scale-[0.99]"
        >
        ...
        <Link
          href="/sign-in"
          className="flex w-full items-center justify-center gap-3 rounded-2xl border border-white/10 bg-[#161a24] px-4 py-3.5 text-xs sm:text-sm font-semibold text-white transition-all hover:bg-[#1f2433] hover:border-white/20 active:scale-[0.99]"
        >
