...
1. `README.md`
2. `documentation/01-PRODUCT.md`
3. `documentation/02-MVP.md`
4. `documentation/03-USER-FLOWS.md`
5. `documentation/04-ARCHITECTURE.md`
6. `documentation/05-AI-EVIDENCE-SYSTEM.md`
7. `documentation/06-ROADMAP.md`
8. `documentation/07-DECISIONS.md`
9. `CONTRIBUTING.md`
10. `documentation/08-VERIFICATION.md`
